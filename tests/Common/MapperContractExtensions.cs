...
namespace EricksonLopez.Mapper.Tests.Common;

/// <summary>
/// Reusable assertion helpers for validating mapping contracts, value equality, and allocation invariants across test suites.
/// </summary>
public static class MapperContractExtensions
{
    /// <summary>
