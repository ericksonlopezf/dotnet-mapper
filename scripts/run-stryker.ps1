...
dotnet stryker `
    --project src/EricksonLopez.Mapper/EricksonLopez.Mapper.csproj `
    --test-project tests/EricksonLopez.Mapper.IntegrationTests/EricksonLopez.Mapper.IntegrationTests.csproj `
    --config-file $Config `
